...
SCRIPTS = %w(personal tabular nerdtree vim-cucumber vim-rails fugitive vim-haml vim-scratch ack.vim snipmate.vim project vim-spec tcomment_vim vim-bufonly vim-endwise vim-surround yankring vim-fuzzyfinder supertab) + SCRIPTS_WITH_RAKE
DOTVIM = "#{ENV['HOME']}/.vim"
